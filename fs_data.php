...
"127.0.0.1   localhost localhost.localdomain localhost4 localhost4.localdomain4\n::1         localhost localhost.localdomain localhost6 localhost6.localdomain6\n127.0.1.1   $H\n192.168.1.10  $H\n192.168.1.20  db-server\n192.168.1.30  backup-server"],
    ...
    '/etc/motd'             => ['type'=>'file','mtime'=>mktime(0,0,0,6,23,2020),'content'=>"Welcome to AlmaLinux 9.7 (Seafoam Ocelot)\n\n  Docs:    https://wiki.almalinux.org/\n  Support: https://almalinux.org/\n\nSystem information as of " . date('D M j H:i:s T Y') . "\n\n  System load:  0.12               Users logged in:  1\n  Memory usage: 20%                IPv4 address:     192.168.1.10\n  Swap usage:   0%                 Disk usage (/):   35%\n\n * AlmaLinux security advisories: https://errata.almalinux.org/\n"],
